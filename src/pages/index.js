...
const IndexPage = () => {
    ...
    return (
        ...
        >
            ...
            <div className="mx-2 -mb-4 mt-auto self-end text-xs text-white">
                icons provided by <span className="text-blue-400">Freepik</span>
            </div>
...
export const Head = () => (
    <>
        ...
        <meta
            name="description"
            content="Explore the NASA media database, images, videos and audios about space exploration."
        />
    </>
);
